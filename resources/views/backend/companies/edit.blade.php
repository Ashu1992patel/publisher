        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="regForm" action="{{ url('companiess/'.$company->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name" placeholder="Company Name" value="{{ isset($company->name)?$company->name:'' }}" autocomplete="off" required>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="pay">Website URL</label>
                                        <input type="url" name="website" class="list-dt form-control" id="website" placeholder="e.g. white-force.com" value="{{ isset($company->website)?$company->website:'' }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ isset($company->type)?$company->type:'' }}" class="list-dt form-control" name="type" />
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="pay">
                                            ...
                                            @else
                                            <span class="text-muted digits">
                                                <small>(Please Upload Icon)</small>
                                            </span>
                                            @endif
                                        </label>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ isset($company->address)?$company->address:'' }}" class="list-dt form-control" name="address" required id="address" />
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label class="pay">About Company</label>
                                        <textarea name="about" class="form-control" id="about" cols="5" rows="3" required>{{ isset($company->about)?$company->about:'' }}</textarea>
                                    </div>
                                </div>
