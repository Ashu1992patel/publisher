...
<head>
    ...
    <link rel="icon" href="{{ url('/') }}/assets/images/dashboard/favicon.png" type="image/x-icon">
    <link rel="shortcut icon" href="{{ url('/') }}/assets/images/dashboard/favicon.png" type="image/x-icon">
    ...
    <!-- jsgrid css-->
    <link rel="stylesheet" type="text/css" href="{{ url('/') }}/assets/css/jsgrid.css">
    ...
    <div class="page-wrapper">
		...
		c1.923,0,3.84-0.728,5.303-2.192l-83.142-83.142L393.695,417.909z" />
                            ...
                            <div class="single-item">
                                <div>
                                    <div>
                                        <h3>Welcome to Publisher</h3>
                                        <p>
                                            The Temporary Staffing business division of SaiSun offers flexible and cost-effective solution and address the headcount needs and limitations of a client squarely.
                                        </p>
                                    </div>
                                </div>
                                <div>
                                    <div>
                                        <h3>Welcome to Broadcaster</h3>
                                        <p>
                                            The Recruitment Solutions that is offered by SaiSun helps recruiters with the non-core processes in recruitment.
                                        </p>
                                    </div>
                                </div>
                                <div>
                                    <div>
                                        <h3>Welcome to Publisher</h3>
                                        <p>
                                            The Screening business division of SaiSun specializes in recruiting for management roles for Corporate across the various industry segments.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card tab2-card">
                            <div class="card-body">
                                <ul class="nav nav-tabs nav-material" id="top-tab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="top-profile-tab" data-toggle="tab" href="#top-profile" role="tab" aria-controls="top-profile" aria-selected="true"><span class="fa fa-user"> </span> Login</a>

                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="contact-top-tab" data-toggle="tab" href="#top-contact" role="tab" aria-controls="top-contact" aria-selected="false"><span class="fa fa-plus-square"> </span> Register</a>
                                    </li>
                                </ul>
                                <div class="tab-content" id="top-tabContent">
                                    <div class="tab-pane fade show active" id="top-profile" role="tabpanel" aria-labelledby="top-profile-tab">
                                        <form method="POST" action="{{ route('login') }}" class="form-horizontal auth-form">
                                            ...
                                            <div class="form-group">
                                                <input required="required" name="email" type="email" class="form-control @error('email') is-invalid @enderror" placeholder="Username" value="{{ old('email') }}" id="email" autofocus autocomplete="email">
                                    ...
                                    <div class="tab-pane fade" id="top-contact" role="tabpanel" aria-labelledby="contact-top-tab">
                                        <form method="POST" action="{{ route('register') }}" class="form-horizontal auth-form">
                                            ...
                                            <div class="form-group">
                                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required placeholder="Username / Email ID" autocomplete="email">
